          ...
          <table class="table table-bordered table-hover" id="example">
            ...
            <?php
                    ...
                    $data = mysqli_query($koneksi, "SELECT * from tb_mapel, tb_guru, tb_kelas WHERE
                      (tb_mapel.id_guru=tb_guru.id_guru) and (tb_kelas.id_kelas=tb_mapel.id_kelas) AND tb_mapel.id_kelas='$id_kelas' ");
            ...
            <tr>
              ...
              <td>
                <center>
                  ...
                  <a href="materi.php?id_mapel=<?= $d['id_mapel'] ?>&id_guru=<?= $d['id_guru'] ?>">

		...
		<div class="main">
            ...
            <div class="panel">
              ...
              $data = mysqli_query($koneksi, "SELECT * from tb_industri, tb_siswa, tb_pengajuan, tb_kelas	where
								(tb_pengajuan.id_industri=tb_industri.id_industri and tb_pengajuan.nisn_siswa=tb_siswa.nisn_siswa	AND tb_siswa.id_kelas=tb_kelas.id_kelas) AND tb_pengajuan.id_pengajuan='$id_pengajuan' ");
							if (empty($data)) {
              ...
              <div class="panel-body">
                ...
                <br>
								...
								<br>
								<center>
									<a href="pengajuan_terima.php?id_pengajuan=<?= $d['id_pengajuan'] ?>" class="btn btn-success btn-xs"
										onclick="return confirm('Anda yakin Ijinkan Prakerin Siswa <?php echo $d['nama_siswa']; ?> ?')">Diterima</a>
									<a href="pengajuan_tolak.php?id_pengajuan=<?= $d['id_pengajuan'] ?>" class="btn btn-danger btn-xs"
											onclick="return confirm('Anda yakin Tolak Prakerin Siswa <?php echo $d['nama_siswa']; ?> ?')">Ditolak</a>
								</center>
			      <?php
							  }
								?>
